...
var Hero = /** @class */ (function () {
    ...
    Hero.fromLi = function (li) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, li.all(by.css('a')).getText()];
                    case 1:
    ...
    Hero.fromDetail = function (detail) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, detail.all(by.css('div')).first().getText()];
                    case 1:
                        _id = _a.sent();
                        return [4 /*yield*/, detail.element(by.css('h2')).getText()];
                    case 2:
                        _name = _a.sent();
                        return [2 /*return*/, {
...
describe('Tutorial part 6', function () {
    ...
    function getPageElts() {
        var navElts = element.all(by.css('app-root nav a'));
        return {
            navElts: navElts,
    ...
    describe('Heroes tests', function () {
        ...
        it('displays correctly styled buttons', function () { return __awaiter(void 0, void 0, void 0, function () {
            var addButton;
            return __generator(this, function (_a) {
                element.all(by.buttonText('x')).then(function (buttons) {
...
function expectHeading(hLevel, expectedText) {
    var hTag = "h" + hLevel;
    var hText = element(by.css(hTag)).getText();
    expect(hText).toEqual(expectedText, hTag);
}
;
function getHeroAEltById(id) {
    var spanForId = element(by.cssContainingText('li span.badge', id.toString()));
